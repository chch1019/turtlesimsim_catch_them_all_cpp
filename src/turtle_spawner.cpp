...
public:
    TurtleSpawnerNode() : Node("turtle_spawner"), turtle_counter_(0)
    {
        ...
        alive_turtles_publisher_ =
            this->create_publisher<turtlesimsim_catch_them_all_cpp::msg::TurtleArray>("alive_turtles", 10);
        ...
        catch_turtle_service_ = this->create_service<turtlesimsim_catch_them_all_cpp::srv::CatchTurtle>(
...
private:
    ...
    {
        auto msg = turtlesimsim_catch_them_all_cpp::msg::TurtleArray();
        msg.turtles = alive_turtles_;
        alive_turtles_publisher_->publish(msg);
    }

    void callbackCatchTurtle(const turtlesimsim_catch_them_all_cpp::srv::CatchTurtle::Request::SharedPtr request,
                             const turtlesimsim_catch_them_all_cpp::srv::CatchTurtle::Response::SharedPtr response)
    {
    ...
    void callSpawnTurtleService(double x, double y, double theta)
    {
        ...
        try
        {
            ...
            if (response->name != "")
            {
                auto new_turtle = turtlesimsim_catch_them_all_cpp::msg::Turtle();
    ...
    int turtle_counter_;
    std::vector<turtlesimsim_catch_them_all_cpp::msg::Turtle> alive_turtles_;

    rclcpp::Publisher<turtlesimsim_catch_them_all_cpp::msg::TurtleArray>::SharedPtr alive_turtles_publisher_;
    rclcpp::Service<turtlesimsim_catch_them_all_cpp::srv::CatchTurtle>::SharedPtr catch_turtle_service_;
